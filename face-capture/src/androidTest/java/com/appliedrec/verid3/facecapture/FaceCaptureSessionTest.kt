...
class FaceCaptureSessionTest {
    ...
    private class MockFaceDetection: FaceDetection {
        ...
        override suspend fun detectFacesInImage(image: IImage, limit: Int): Array<Face> = coroutineScope {
            ...
            arrayOf(Face(faceBounds, EulerAngle(0f, 0f, 0f), 10f, emptyArray(), -1, -1))
        }
